          ...
          <div className="mb-10">
            ...
            {data.personalized_recommendations.map((rec, i) => (
              ...
              >
                ...
                <p className="text-[#19C481] text-[14px]">→ {rec.suggestion}</p>
                {rec.goal_alignment && (
                  <p className="text-[#A3A3A3] text-[12px]">
                    Goal:{" "}
                    <span className="text-[#E89E28]">{rec.goal_alignment}</span>
                  </p>
                )}
                {rec.cultural_note && (
